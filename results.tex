...
\begin{table*}[h]
	\begin{center} %\footnotesize
		\caption{ Comparison of the proposed optimization method against the existing SLP-based method and DNN-based CG method}
		\label{table:results}
		\center
		\resizebox{\textwidth}{!}{
			\begin{tabular}{| c| c | c | c | c | c | c  | c | c | c | }
				...
				{} &{} &\multicolumn{2}{c|} {Existing SLP~\cite{Sukharev:2019pg}} &\multicolumn{2}{c|} {DNN-based CG~\cite{HanLiu:TCAD'22-23}} &\multicolumn{2}{c|} {DNN-based SLP} &{} &{}\\ 
				\cline{3-8}
				\multirow{-2}{*}{Circuit}
                                   &\multirow{-2}{*}{PG Size} &{Area
                                                                Increase}
                                                                                                  &{Time
                                                                                                    (s)}
                                                                                                                                                               &{Area
                                                                                                                                                                 Increase}
                                                                                                                                                                                                    &{Time
                                                                                                                                                                                                      (s)}
                                                                                                                                                                                                        &{Area
                                                                                                                                                                                                          Increase}
                                   &{Time (s)} &\multirow{-2}{*}{SP ov
                                                 \cite{Sukharev:2019pg}}
                                                                                                  &\multirow{-2}{*}{SP ov~\cite{HanLiu:TCAD'22-23}}   \\ \hline 
				\hline 
	...
	\vspace{-0.1in}
      ...
      the power grid increase, we see more speedup. % Since the cost on
% building {\it Jacobian} matrix with circuit analysis is a high-order
% polynomial to the power grid size, the conventional SLP-based method
% suffered suffers more time consumption from the larger power grid.
