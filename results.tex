	...
	\begin{center} 
		...
		\resizebox{0.48\textwidth}{!}{
			\begin{tabular}{| c| c | c | c | }
				...
				\cline{3-4}
				\multirow{-2}{*}{Circuit}   &\multirow{-2}{*}{PG Size (\# nodes)} &{ GAN-based model\cite{ZhouJin:ICCAD'20}}  &{ GridVAE}   \\ \hline 
				\hline 
	...
	\begin{center} %\footnotesize
		...
		\resizebox{0.48\textwidth}{!}{
			\begin{tabular}{| c | c | c | c | c | c | c | }
				...
				\cline{3-6} \multirow{-2}{*}{Circuit} & \multirow{-2}{*}{PG Size (\# nodes)} & {Area Increase} & {Time(s)}   &{Area Increase} & {Time (s)} & \multirow{-2}{*}{Speed up}  \\  [4pt]
				\hline 
				\hline 
