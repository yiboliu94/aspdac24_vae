...
The second part is the KL divergence between the latent variable distribution output by the encoder and a chosen prior distribution (usually a multivariate Gaussian distribution), which acts as a regularization term to encourage the network to use the latent space efficiently.  
